...
public class Mb extends Spider {
    ...
    public static void main (String[]args) throws Exception {
        Mb Jx = new Mb();
//        String categoryContent = Jx.categoryContent("20", "1", false, null);
        List<String> ids = new ArrayList<>();
        String homeContent = Jx.homeContent(true);
        ids.add("18472");
        String detailContent = Jx.detailContent(ids);
//        String  playerContent=Jx.playerContent("","http://152.32.210.104/dm2956.php?url=dm295-267-1-3",null);
//            String homeContent = Jx.playerContent("flag", "1162845@134262", new ArrayList<>());
//        String searchContent = Jx.searchContent("海", false, "2");

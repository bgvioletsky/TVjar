...
public class Dm56 extends Spider {
    ...
    private String decrypt(String data, String key, String iv) throws Exception {
       return decrpy.Dm56(data,key,iv);
    }
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) throws Exception {
        ...
        public static void main (String[]args){
            try {
                Dm56 dm56 = new Dm56();
//             测试 homeContent 方法
                String homeContent = dm56.homeContent(false);
...
//                String categoryContent = dm56.categoryContent("1", "1", false, new HashMap<>());
//            System.out.println("Category Content: " + categoryContent);
////
////            // 测试 detailContent 方法
//            List<String> ids = new ArrayList<>();
//            ids.add("/anime/e43620b8ca3139cb59251ecd.html");
//            String detailContent = dm56.detailContent(ids);
////
//            System.out.println("Detail Content: " + detailContent);

//             测试 searchContent 方法
            String searchContent = dm56.searchContent("海", false);
            System.out.println("Search Content: " + searchContent);

////             测试 playerContent 方法
//                String playerContent = dm56.playerContent("flag", "https://www.56dm.cc/anime/9b90cfa776c0257c5b7371dd/play/3/1.html", new ArrayList<>());
...
//                String decryptedText = dm56.decrypt(data, keyHex, ivHex);
